...
#Основні компоненти коду включають класи Cls, Teacher та Lesson, які представляють класи, вчителів та уроки відповідно.
class Cls:
...
def main():
    ...
    teachers = [
        Teacher("Teacher 1", ["Math", "English", "Science", "Informatic"]),
        Teacher("Teacher 2", ["Math", "English", "Science", "Music"]),
        Teacher("Teacher 3", ["Math", "English", "Science", "Informatic"]),
        Teacher("Teacher 4", ["Physical Education", "Karate"]),
    ]

    room_names = ["Room 1", "Room 2", "Room 3", "Physical Education Room", "Karate Room", "Music Room"]

    class_names = ["Class A", "Class B", "Class C"]

    lesson_names = [["Math", False, "None"], ["English", False, "None"], ["Science", False, "None"],
                    ["Informatic", False, "None"], ["Physical Education", True, "Physical Education Room"], ["Karate", True, "Karate Room"],
                    ["Music", True, "Music Room"]]

    input_file="input_file"
    output_file="output_file.txt"
    # Запис даних у файл
    write_data_to_file(output_file, num_lessons, num_classes, num_days, max_lessons_per_day,
                       teachers, room_names, class_names, lesson_names)
